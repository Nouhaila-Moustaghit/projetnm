            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        ...
                        <input type="text" name = "qte" class="form-control bg-secondary text-center" value="<%=l.getQuantite()%>">
                        <div class="input-group-btn">
                    ...
                    <a href="gestionPanier?action=ajouter&id=<%=p.getId()%>&qte=<%=l.getQuantite()%>" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</a>
                </div>
