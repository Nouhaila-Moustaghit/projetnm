...
<body>
            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        somme = somme+(l.getQuantite()*p.getPrix());
                        %>
                        <tr>
                            ...
                            <td class="align-middle"><a class="btn btn-sm btn-primary" href="gestionPanier?action=supprimer&idproduit=<%= p.getId()%>&idcommande=<%=l.getCommande().getId()%>"><i class="fa fa-times"></i></a></td>
                        </tr>
                       <%}%>
                    </tbody>
                </table>
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            ...
                            <h6 class="font-weight-medium"><%=somme%> Dh</h6>
                        </div>
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <h5 class="font-weight-bold"><%=somme%> Dh</h5>
                        </div>
    ...
    <script src="templateClient/js/panier.js"></script>
</body>
